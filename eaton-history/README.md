...
> Extract Eaton history file as entities for Home Assistant

## Update
> https://github.com/MortalFlesh/home-console/releases

Pick latest release and update it in:
- Dockerfile: `CONSOLE_VERSION`
